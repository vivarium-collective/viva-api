...
| P4b | #776 reshaped per D15 + the SMS adapters; `/viva/v1/{tasks,jobs}`; `task_script` | | | | slice 1 (the seam, #776 reshaped) in PR #840; slices 2–4 not started (checkpoint G); = slice 2 of the data-provenance track (`plan-task-provenance.md`), folded 2026-09-26 |
