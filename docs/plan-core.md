...
- **Type coverage: `strict` is not "no `Any`".** Measured 2026-09-20 on `main`: `strict = true` over
  ...
  expressions), `simulation/ray` 92.92 % → **99.84 %** (135 → 3), the repository 92.70 % → 93.44 %.
