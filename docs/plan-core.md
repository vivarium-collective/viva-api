...
| P-jump | Stanford prod 0.9.78 → F | #839 | 0.9.159 | F | **2026-09-26** | **done** — migration Job (10 revisions → `a4b6c8d0e2f4`), app 0.9.159, workbench 0.3.85, `/viva` ALB rule; snapshot `pre-0-9-159-pjump-2026-09-26`; smoke T0/T1 12 passed / 2 failed / 3 skipped; Tier 2 later (Jim) |
