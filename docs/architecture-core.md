...
viva_core/
  ...
  tasks/      snapshot, …
  datasets/   models, registry  (P4a-2 slice 1: in place -- the trace feeder behind OwnerResolver + DatasetStore); walk (slice 2)
