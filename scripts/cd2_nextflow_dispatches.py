...
* ``injected_processes``  <- ``viva_api.simulation.dispatch.config_interpretation
...
from viva_api.simulation.dispatch.config_interpretation import injected_processes_from_config
