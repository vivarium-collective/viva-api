"""Moved to :mod:`viva_core.api.routers.env_worker` (core split, ``docs/plan-core.md`` P3d-4d-2b).
...
from viva_core.api.routers import env_worker as _moved

if TYPE_CHECKING:
    from viva_core.api.routers.env_worker import *  # noqa: F403
