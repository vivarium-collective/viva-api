...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/simulations/workspace",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Export a simulator's repo@commit workspace as a gzipped tarball
    ...
    Args:
        simulator_id (int): database_id of the simulator to export
