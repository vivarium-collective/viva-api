    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            ...
            def _parse_response_200_item(data: object) -> Union["OutputFileMetadata", "TsvOutputFile"]:
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_200_item_type_0 = TsvOutputFile.from_dict(data)
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                response_200_item_type_1 = OutputFileMetadata.from_dict(data)
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, list[Union['OutputFileMetadata', 'TsvOutputFile']]]
    """
