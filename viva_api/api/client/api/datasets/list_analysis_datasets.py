...
from ...models.list_analysis_datasets_available import ListAnalysisDatasetsAvailable
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/v1/analyses/{id}/datasets",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Datasets an analysis run wrote
    ...
    Args:
        ...
        available (Union[Unset, ListAnalysisDatasetsAvailable]): 'true' (default): datasets whose
            object exists; 'false': those whose object is gone; 'any'. Default:
