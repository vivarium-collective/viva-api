...
from ...models.body_compose_run_tellurium import BodyComposeRunTellurium
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/compose/v1/curated/tellurium",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Run Tellurium simulation from SBML
