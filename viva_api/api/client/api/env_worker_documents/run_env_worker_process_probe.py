...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/env-worker/v1/relay/workers/{job_name}/process-run",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Run a single update() of one process — a probe, not a job
    ...
    Args:
        job_name (str):
        body (ProcessRun): One `update()` -- a probe, not a job. `env_worker._run_process` is
