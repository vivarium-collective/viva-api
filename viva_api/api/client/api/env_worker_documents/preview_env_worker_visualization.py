...
from ...models.viz_preview import VizPreview
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/env-worker/v1/relay/workers/{job_name}/visualizations/preview",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Render a visualization class to preview HTML
