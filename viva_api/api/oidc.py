"""Moved to :mod:`viva_core.api.oidc` (core split, ``docs/plan-core.md`` P3d-4d-2b).
...
from viva_core.api import oidc as _moved

if TYPE_CHECKING:
    from viva_core.api.oidc import *  # noqa: F403
