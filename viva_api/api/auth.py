"""Moved to :mod:`viva_core.api.auth` (core split, ``docs/plan-core.md`` P3d-4d-2b).
...
from viva_core.api import auth as _moved

if TYPE_CHECKING:
    from viva_core.api.auth import *  # noqa: F403
