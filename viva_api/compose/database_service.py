"""Moved to :mod:`viva_core.compose.database_service` (core split, ``docs/plan-core.md`` P3d-4b-3).
...
from viva_core.compose import database_service as _moved

if TYPE_CHECKING:
    from viva_core.compose.database_service import *  # noqa: F403
