"""Moved to :mod:`viva_core.compose.container_def` (core split, ``docs/plan-core.md`` P3d-4b-2).
...
from viva_core.compose import container_def as _moved

if TYPE_CHECKING:
    from viva_core.compose.container_def import *  # noqa: F403
