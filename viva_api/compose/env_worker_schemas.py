"""Moved to :mod:`viva_core.env_worker.schemas` (core split, ``docs/plan-core.md`` P3d-4b-3).
...
from viva_core.env_worker import schemas as _moved

if TYPE_CHECKING:
    from viva_core.env_worker.schemas import *  # noqa: F403
