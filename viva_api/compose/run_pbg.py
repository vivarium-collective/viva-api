"""Moved to :mod:`viva_core.compose.run_pbg` (core split, ``docs/plan-core.md`` P3d-4c-2).
...
from viva_core.compose import run_pbg as _moved

if TYPE_CHECKING:
    from viva_core.compose.run_pbg import *  # noqa: F403
