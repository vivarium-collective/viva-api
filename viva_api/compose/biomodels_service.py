"""Moved to :mod:`viva_core.contrib.sysbio.biomodels_service` (core split, ``docs/plan-core.md`` P3d-4d-2a).
...
from viva_core.contrib.sysbio import biomodels_service as _moved

if TYPE_CHECKING:
    from viva_core.contrib.sysbio.biomodels_service import *  # noqa: F403
