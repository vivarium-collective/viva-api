"""Moved to :mod:`viva_core.compose.tables_orm` (core split, ``docs/plan-core.md`` P3d-4b-3).
...
from viva_core.compose import tables_orm as _moved

if TYPE_CHECKING:
    from viva_core.compose.tables_orm import *  # noqa: F403
