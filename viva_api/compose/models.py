"""Moved to :mod:`viva_core.compose.models` (core split, ``docs/plan-core.md`` P3d-4b-2).
...
from viva_core.compose import models as _moved

if TYPE_CHECKING:
    from viva_core.compose.models import *  # noqa: F403
