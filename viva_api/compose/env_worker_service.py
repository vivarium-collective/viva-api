"""Moved to :mod:`viva_core.env_worker.service` (core split, ``docs/plan-core.md`` P3d-4a).
...
from viva_core.env_worker import service as _moved

if TYPE_CHECKING:
    from viva_core.env_worker.service import *  # noqa: F403
