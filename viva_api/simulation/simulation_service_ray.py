...
class SimulationServiceRay(RayParcaMixin, RayBatchLayer):
    ...
    @property
    def analysis(self) -> RayAnalysisService:
        """The analysis service, composed the same way as ``tasks``: handed this service as
        its dispatcher, built per access, holding no state."""
        return RayAnalysisService(self)
