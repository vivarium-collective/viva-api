"""Moved to :mod:`viva_core.infra.messaging.messaging_service_redis` (core split, ``docs/plan-core.md`` P1).
...
from viva_core.infra.messaging import messaging_service_redis as _moved

if TYPE_CHECKING:
    from viva_core.infra.messaging.messaging_service_redis import *  # noqa: F403
