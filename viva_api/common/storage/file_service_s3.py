"""Moved to :mod:`viva_core.storage.file_service_s3` (core split, ``docs/plan-core.md`` P1).
...
from viva_core.storage import file_service_s3 as _moved

if TYPE_CHECKING:
    from viva_core.storage.file_service_s3 import *  # noqa: F403
