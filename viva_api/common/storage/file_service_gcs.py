"""Moved to :mod:`viva_core.storage.file_service_gcs` (core split, ``docs/plan-core.md`` P1).
...
from viva_core.storage import file_service_gcs as _moved

if TYPE_CHECKING:
    from viva_core.storage.file_service_gcs import *  # noqa: F403
