"""Moved to :mod:`viva_core.storage.file_paths` (core split, ``docs/plan-core.md`` P1).
...
from viva_core.storage import file_paths as _moved

if TYPE_CHECKING:
    from viva_core.storage.file_paths import *  # noqa: F403
