"""Moved to :mod:`viva_core.storage.gcs_aio` (core split, ``docs/plan-core.md`` P1).
...
from viva_core.storage import gcs_aio as _moved

if TYPE_CHECKING:
    from viva_core.storage.gcs_aio import *  # noqa: F403
