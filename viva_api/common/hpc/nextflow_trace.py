"""Moved to :mod:`viva_core.backends.nextflow_trace` (core split, ``docs/plan-core.md`` P1).
...
from viva_core.backends import nextflow_trace as _moved

if TYPE_CHECKING:
    from viva_core.backends.nextflow_trace import *  # noqa: F403
