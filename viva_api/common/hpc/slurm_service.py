"""Moved to :mod:`viva_core.backends.slurm_service` (core split, ``docs/plan-core.md`` P1).
...
from viva_core.backends import slurm_service as _moved

if TYPE_CHECKING:
    from viva_core.backends.slurm_service import *  # noqa: F403
