"""Moved to :mod:`viva_core.backends.job_service` (core split, ``docs/plan-core.md`` P1).
...
from viva_core.backends import job_service as _moved

if TYPE_CHECKING:
    from viva_core.backends.job_service import *  # noqa: F403
