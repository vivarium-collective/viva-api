"""Moved to :mod:`viva_core.backends.nextflow_weblog` (core split, ``docs/plan-core.md`` P1).
...
from viva_core.backends import nextflow_weblog as _moved

if TYPE_CHECKING:
    from viva_core.backends.nextflow_weblog import *  # noqa: F403
