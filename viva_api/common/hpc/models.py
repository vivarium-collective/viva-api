"""Moved to :mod:`viva_core.backends.models` (core split, ``docs/plan-core.md`` P1).
...
from viva_core.backends import models as _moved

if TYPE_CHECKING:
    from viva_core.backends.models import *  # noqa: F403
