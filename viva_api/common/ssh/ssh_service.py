"""Moved to :mod:`viva_core.infra.ssh.ssh_service` (core split, ``docs/plan-core.md`` P1).
...
from viva_core.infra.ssh import ssh_service as _moved

if TYPE_CHECKING:
    from viva_core.infra.ssh.ssh_service import *  # noqa: F403
