...
from viva_core.env_worker.service import (
    EnvWorkerJobExists,
...
if TYPE_CHECKING:
    from viva_core.compose.database_service import EnvWorkerTaskDatabaseService
...
@router.post(
    ...
    tags=[_DOCS],
    summary="Translate a simulator config document into a composite document",
)
