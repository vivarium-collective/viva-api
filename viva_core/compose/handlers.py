...
async def run_compose_simulation(
    ...
    experiment_id = compose_experiment_id(simulator=simulator_version, random_str=random_string)
    ...
    placeholder_hpcrun = await hpc_db.insert_hpcrun(
        ...
        correlation_id=compose_correlation_id(random_string=random_string, job_type=ComposeJobType.SIMULATION),
    )
