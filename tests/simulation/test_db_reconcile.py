...
The fingerprint vectors below are length-9, matching LEGACY_FINGERPRINTS:
...
def test_managed_database_takes_upgrade_path() -> None:
    diag = classify(
        ...
        fingerprint=[True, True, False, False, False, False, False, False, False],
        head_revision=HEAD,
    )
...
def test_managed_takes_precedence_even_with_odd_fingerprint() -> None:
    diag = classify(
        ...
        fingerprint=[False, False, False, False, False, False, False, False, False],
        head_revision=HEAD,
    )
    assert diag.state is DbState.MANAGED
...
def test_legacy_matches_baseline_only() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, False, False, False, False, False, False, False, False],
        head_revision=HEAD,
    )
...
def test_legacy_matches_cancelled_revision() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, True, True, False, False, False, False, False, False],
        head_revision=HEAD,
    )
    assert diag.state is DbState.LEGACY
...
def test_legacy_matches_tags_revision() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, True, True, True, False, False, False, False, False],
        head_revision=HEAD,
    )
    assert diag.state is DbState.LEGACY
...
def test_legacy_matches_analysis_revision() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, True, True, True, True, False, False, False, False],
        head_revision=HEAD,
    )
    assert diag.state is DbState.LEGACY
...
def test_legacy_matches_compose_hpcrun_revision() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, True, True, True, True, True, False, False, False],
        head_revision=HEAD,
    )
    assert diag.state is DbState.LEGACY
...
def test_legacy_matches_chain_dispatch_revision() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, True, True, True, True, True, True, False, False],
        head_revision=HEAD,
    )
    assert diag.state is DbState.LEGACY
...
def test_legacy_matches_pending_and_cancelled_uppercase_revision() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, True, True, True, True, True, True, True, False],
        head_revision=HEAD,
    )
    assert diag.state is DbState.LEGACY
...
def test_legacy_matches_head_when_all_markers_present() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, True, True, True, True, True, True, True, True],
        head_revision=HEAD,
    )
    assert diag.state is DbState.LEGACY
...
def test_inconsistent_when_later_marker_present_but_earlier_missing() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, False, True, False, False, False, False, False, False],
        head_revision=HEAD,
    )
...
def test_inconsistent_when_baseline_missing_but_later_present() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[False, True, True, True, True, True, True, True, True],
        head_revision=HEAD,
    )
    assert diag.state is DbState.INCONSISTENT
    assert diag.can_upgrade is False
...
def test_markers_are_reported_with_labels() -> None:
    ...
    assert presence == [True, True, False, False, False, False, False, False, False]
