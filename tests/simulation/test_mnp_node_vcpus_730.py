...
def _vcpus(fake: Any, job_definition: str = "base-mnp-abc:3") -> tuple[int | None, Any]:
    ...
    with (
        ...
        patch("viva_api.simulation.simulation_service_ray.time.sleep") as slept,
    ):
        return service._mnp_node_vcpus(job_definition), slept
...
def test_a_wrong_call_is_loud_is_not_retried_and_still_does_not_fail_the_dispatch() -> None:
    ...
    with patch("viva_api.simulation.simulation_service_ray.logger.exception") as logged:
